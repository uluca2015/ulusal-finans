...
.view{display:none;animation:fadein .15s ease;width:100%;min-height:0}.view.on{display:block;width:100%;min-height:50px}
...
.tc-ipotek::-webkit-scrollbar { width: 8px; height: 8px; }
.tc-ipotek::-webkit-scrollbar-track { background: var(--s2); border-radius: 4px; }
.tc-ipotek::-webkit-scrollbar-thumb { background: var(--b2); border-radius: 4px; }
.tc-ipotek::-webkit-scrollbar-thumb:hover { background: var(--acc); }
.tc-ipotek table { min-width: 1800px !important; }
...
<div class="view" id="vw-ipotek" style="min-height:0">
  ...
  <div class="tc-ipotek" style="overflow-x:scroll;overflow-y:auto;max-height:calc(100vh - 310px);border-radius:10px;border:1px solid var(--b2);width:100%;display:block">

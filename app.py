...
.tc-ipotek::-webkit-scrollbar { width: 10px; height: 10px; }
.tc-ipotek::-webkit-scrollbar-track { background: var(--s3); border-radius: 4px; }
.tc-ipotek::-webkit-scrollbar-thumb { background: var(--acc); border-radius: 4px; }

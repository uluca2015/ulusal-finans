  ...
  <div class="ov" id="taksitli-mod" style="display:none">
    <div class="mod" style="max-width:700px;width:96%;max-height:92vh;overflow-y:auto">
      ...
      <div style="padding:16px;display:grid;grid-template-columns:1fr 1fr;gap:10px">
        ...
        <div id="tk-alan-baslangic"><label class="flb">İlk Taksit / Başlangıç Tarihi *</label>
...
function tkTurDegis(){
  ...
  // Taksitli alanlar
  ['tk-alan-vade','tk-alan-bsmv'].forEach(id=>{
    const el=document.getElementById(id);
...
function taksitliYeniAc(){
  ...
  ['tk-kredi-no','tk-ana-para','tk-faiz','tk-vade','tk-baslangic','tk-aciklama',

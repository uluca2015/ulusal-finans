...
def save_users(users):
    ...
    # GitHub'a da yedekle (Render'da yeniden başlamada kaybolmasın)
    try:
        if GITHUB_TOKEN:
        ...
        try:
            ...
            if token and get_session(token):
                self.send_header('Set-Cookie',
                    f'na_token={token}; Path=/; HttpOnly; SameSite=Lax; Max-Age=31536000')
        except: pass
        self.end_headers()
        ...
        if self.path == '/api/login':
            ...
            try:
                ...
                if u and u['password'] == hash_password(password):
                    ...
                    self.send_header('Set-Cookie',f'na_token={token}; Path=/; HttpOnly; SameSite=Lax; Max-Age=31536000')

    ...
    <div style="background:var(--s2);border:1px solid var(--b2);border-radius:12px;overflow:hidden">
      ...
      <div style="padding:14px 18px;display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px">
          ...
          <div style="display:flex;gap:12px;margin-top:8px;flex-wrap:wrap">
            ...
            ${BK_TURLER.map(t=>{
              ...
              return `<span style="font-size:11px;background:var(--s3);padding:3px 8px;border-radius:6px">
                ...
                <span style="color:var(--t3);font-size:12px"> kalan</span>
        ...
        <div style="background:var(--s3);border-radius:8px;padding:10px">
          ...
          <div style="font-size:12px;color:var(--am);font-weight:700;margin-bottom:6px">ŞUBE MÜDÜRÜ</div>
        ...
        <div style="background:var(--s3);border-radius:8px;padding:10px">
          ...
          <div style="font-size:12px;color:var(--g);font-weight:700;margin-bottom:6px">İLGİLİ PERSONEL</div>
        ...
        <div style="background:var(--s3);border-radius:8px;padding:10px">
          ...
          <div style="font-size:12px;color:var(--acc);font-weight:700;margin-bottom:6px">HESAPLAR & İPOTEKLER</div>

          ${hesaplar.length?hesaplar.map(h=>`<div style="font-size:11px;color:var(--t2);margin-bottom:3px">

            <span style="background:var(--s2);padding:2px 6px;border-radius:4px;font-size:12px;color:var(--acc)">${h.tur||''}</span>

...
<div class="view" id="vw-tbl">
  ...
  <div id="tur-ozet-wrap" style="margin-top:10px;display:none">
    <div style="font-size:12px;font-weight:600;color:var(--t3);margin-bottom:6px;padding:0 2px">
      Filtre Özeti — Tür Bazlı Nakit Çıkışları
    </div>
    <div id="tur-ozet-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:8px"></div>
    <div id="tur-ozet-toplam" style="margin-top:8px;padding:10px 14px;background:var(--s2);border-radius:8px;border:1px solid var(--b1);display:flex;flex-wrap:wrap;gap:16px;font-size:12px;font-family:var(--mono)"></div>
  </div>

  ...
  <div class="src-card" style="margin:0;background:rgba(79,156,249,.04);border-color:rgba(79,156,249,.2)">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;flex-wrap:wrap;gap:8px">
      ...
      <div style="display:flex;gap:8px;align-items:flex-end;flex-wrap:wrap">
        ...
        <!-- Çoklu Yıl Seçimi -->
        <div>
          <div style="font-size:10px;color:var(--t3);font-family:var(--mono);margin-bottom:3px">YIL (çoklu)</div>
          <select class="fi" id="fn-yil" multiple size="3"
            style="font-size:12px;min-width:90px;height:62px;background:var(--s2);border:1px solid var(--b1);border-radius:var(--rad);color:var(--t1);padding:2px 4px"
            title="Ctrl ile çoklu seçim yapabilirsiniz">
          </select>
        </div>

        <!-- Çoklu Ay Seçimi -->
        <div>
          <div style="font-size:10px;color:var(--t3);font-family:var(--mono);margin-bottom:3px">AY (çoklu)</div>
          <select class="fi" id="fn-ay" multiple size="3"
            style="font-size:12px;min-width:100px;height:62px;background:var(--s2);border:1px solid var(--b1);border-radius:var(--rad);color:var(--t1);padding:2px 4px"
            title="Ctrl ile çoklu seçim yapabilirsiniz">
            <option value="Ocak">Ocak</option><option value="Şubat">Şubat</option>
            ...
            <option value="Temmuz">Temmuz</option><option value="Ağustos">Ağustos</option>
            <option value="Eylül">Eylül</option><option value="Ekim">Ekim</option>
            <option value="Kasım">Kasım</option><option value="Aralık">Aralık</option>
          </select>
        </div>

        <!-- Tarih Aralığı -->
        <div>
          <div style="font-size:10px;color:var(--t3);font-family:var(--mono);margin-bottom:3px">BAŞLANGIÇ</div>
          <input type="date" id="fn-bas" class="fi2" style="font-size:12px;width:130px;padding:5px 8px">
        </div>
        <div>
          <div style="font-size:10px;color:var(--t3);font-family:var(--mono);margin-bottom:3px">BİTİŞ</div>
          <input type="date" id="fn-bit" class="fi2" style="font-size:12px;width:130px;padding:5px 8px">
        </div>

        <div style="display:flex;flex-direction:column;gap:4px">
          <button class="btn bp bsm" onclick="hesaplaOneri()">▶ Analiz Et</button>
          <button class="btn bo bsm" onclick="fnFiltreSifirla()" style="font-size:11px">↺ Sıfırla</button>
        </div>
...
async function bkIpotekDetayToggle(bkId){
  ...
  try{
    ...
    inner.innerHTML=`
      ...
      <!-- Çıktı Butonları - bkId değişkeni string concat ile -->
      <div style="display:flex;gap:8px;margin-top:12px;flex-wrap:wrap">
        <button onclick="bkIpotekExcel('" + bkId + "')"
          style="background:rgba(16,185,129,.15);color:var(--g);border:1px solid rgba(16,185,129,.3);padding:6px 14px;border-radius:var(--rad);cursor:pointer;font-size:12px;font-weight:600">
          📊 Excel İndir
        </button>
        <button onclick="bkIpotekPDF('" + bkId + "')"
          style="background:rgba(239,68,68,.12);color:var(--r);border:1px solid rgba(239,68,68,.3);padding:6px 14px;border-radius:var(--rad);cursor:pointer;font-size:12px;font-weight:600">
          📄 PDF İndir
        </button>
        <button onclick="bkIpotekYazdir('" + bkId + "')"
          style="background:rgba(79,156,249,.12);color:var(--acc);border:1px solid rgba(79,156,249,.3);padding:6px 14px;border-radius:var(--rad);cursor:pointer;font-size:12px;font-weight:600">
          🖨 Yazdır
        </button>
      </div>`;
  }catch(e){

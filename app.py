  ...
  document.getElementById('tbody').innerHTML=filtered.slice(start,end).map(d=>{
    ...
    return`<tr>
      ...
      <td style="white-space:nowrap">
        ${d.taksitli_id ? `
          <button class="btn bgh" onclick="odemeTaksitDuzenle(${idx})" title="Taksit satırını düzenle" style="font-size:11px">✏</button>
          <button class="btn bgh" style="color:var(--r);font-size:11px" onclick="odemeTaksitSil(${idx})" title="Taksit satırını sil">✕</button>
        ` : `
